import { IacFileData, IaCTestFlags } from './types';
import { CustomError } from '../../../../lib/errors';
export declare function loadContentForFiles(filePaths: string[]): Promise<IacFileData[]>;
export declare function loadFiles(pathToScan: string, options?: IaCTestFlags, validFileTypes?: string[]): Promise<IacFileData[]>;
