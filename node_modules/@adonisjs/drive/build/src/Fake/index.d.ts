...
import { DisksList, Visibility, ContentHeaders, DriveFileStats, DriveFakeContract } from '@ioc:Adonis/Core/Drive';
/**
 * Memory driver is mainly used for testing
 */
export declare class DriveFake implements DriveFakeContract {
