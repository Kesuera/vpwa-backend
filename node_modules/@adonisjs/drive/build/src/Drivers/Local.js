...
class LocalDriver {
     ...
     */
    makePath(location) {
        return (0, path_1.isAbsolute)(location) ? location : (0, path_1.join)(this.config.root, location);
    }
    /**
    ...
    async getSignedUrl(location, options) {
        ...
        return this.router.makeSignedUrl(this.routeName, { [LocalFileServer_1.LocalFileServer.filePathParamName]: [location] }, {
            expiresIn,
            qs,
        });
    }
    ...
    async getUrl(location) {
        ...
        return this.router.makeUrl(this.routeName, { [LocalFileServer_1.LocalFileServer.filePathParamName]: [location] });
    }
    /**
