...
export interface IocResolverContract<ContainerBindings extends any> {
     ...
     */
    call<Namespace extends Extract<keyof ContainerBindings, string>>(namespace: Namespace | string, prefixNamespace?: string, args?: any[]): Promise<any>;
    call<Namespace extends Extract<keyof ContainerBindings, string>>(namespace: IocResolverLookupNode<Namespace | string>, prefixNamespace: undefined, args?: any[]): Promise<any>;
}
export {};
