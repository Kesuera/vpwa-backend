...
class PartHandler {
    constructor(part, options, drive) {
         ...
         */
        this.canFileTypeBeDetected = utils_2.supportMagicFileTypes.includes((0, path_1.extname)(this.part.filename).replace(/^\./, ''));
        /**
    ...
    async detectFileTypeAndExtension(force) {
        ...
        const fileType = await (0, utils_2.getFileType)(this.buff, this.file.clientName, this.file.headers, force);
        if (fileType) {
