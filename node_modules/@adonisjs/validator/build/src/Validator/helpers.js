...
exports.getRequestReporter = exports.wrapCompile = exports.ensureValidArgs = exports.resolveAbsoluteName = exports.getFieldValue = exports.isRef = exports.enforceDateTime = exports.enforceArray = exports.isObject = exports.exists = exports.existsStrict = void 0;
 ...
 */
function existsStrict(value) {
    return value !== undefined && value !== null;
}
exports.existsStrict = existsStrict;
/**
 ...
 */
function enforceArray(value, message) {
 ...
 */
function enforceDateTime(value, message) {
...
exports.enforceDateTime = enforceDateTime;
/**
 ...
 */
function getFieldValue(field, root, tip) {
 ...
 */
function resolveAbsoluteName(field, otherField) {
    return field[0] === '/'
        ? field.slice(1)
        : otherField.split('.').slice(0, -1).concat(field).join('.');
}
exports.resolveAbsoluteName = resolveAbsoluteName;
/**
 * Validates to ensure that arguments passed to validations compile method
 * is an array
 */
function ensureValidArgs(ruleName, args) {
    /**
...
exports.ensureValidArgs = ensureValidArgs;
/**
 ...
 */
function wrapCompile(name, restrictForTypes, customCallback) {
...
exports.wrapCompile = wrapCompile;
/**
 * Returns the error reporter for the current HTTP request
 */
function getRequestReporter(request) {
    if (request.ajax()) {
...
exports.getRequestReporter = getRequestReporter;
