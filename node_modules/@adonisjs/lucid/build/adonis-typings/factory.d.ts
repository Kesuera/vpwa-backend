declare module '@ioc:Adonis/Lucid/Factory' {
     ...
     */
    export type NewUpCallback<T extends FactoryModelContract<LucidModel>> = (attributes: ExtractFactoryAttributes<T>, ctx: FactoryContextContract) => InstanceType<T['model']>;
    /**
     * Function to merge attributes defined during runtime
     */
    export type MergeCallback<T extends FactoryModelContract<LucidModel>> = (model: InstanceType<T['model']>, attributes: ExtractFactoryAttributes<T>, ctx: FactoryContextContract) => void;
    /**
     * Callback to define a new model state
     */
    export type StateCallback<Model extends LucidRow> = (model: Model, ctx: FactoryContextContract) => any | Promise<any>;
    /**
     * ------------------------------------------------------
     *  Hooks
     * ------------------------------------------------------
     ...
     */
    export type HooksHandler<Model extends FactoryModelContract<LucidModel>> = (factory: FactoryBuilderContract<Model>, model: InstanceType<Model['model']>, ctx: FactoryContextContract) => void | Promise<void>;
    /**
     * ------------------------------------------------------
     *  Runtime context
     * ------------------------------------------------------
     ...
     */
    export type RelationCallback = (factory: FactoryBuilderContract<FactoryModelContract<LucidModel>>) => void;
    /**
    ...
    export interface FactoryBuilderContract<FactoryModel extends FactoryModelContract<LucidModel>> {
         ...
         */
        factory: FactoryModel['relations'][K] extends () => FactoryBuilderContract<any> ? ReturnType<FactoryModel['relations'][K]> : never) => void): this;
        /**
         ...
         */
        make(callback?: (model: InstanceType<FactoryModel['model']>, ctx: FactoryContextContract) => void): Promise<InstanceType<FactoryModel['model']>>;
        /**
         * Create model instance and stub out the persistance
         * mechanism
         */
        makeStubbed(callback?: (model: InstanceType<FactoryModel['model']>, ctx: FactoryContextContract) => void): Promise<InstanceType<FactoryModel['model']>>;
        /**
         * Create and persist model instance
         */
        create(callback?: (model: InstanceType<FactoryModel['model']>, ctx: FactoryContextContract) => void): Promise<InstanceType<FactoryModel['model']>>;
        /**
         * Make model instance without persitance. The makeMany method
         * doesn't process relationships
         */
        makeMany(count: number, callback?: (model: InstanceType<FactoryModel['model']>, ctx: FactoryContextContract) => void): Promise<InstanceType<FactoryModel['model']>[]>;
        /**
         * Create one or more model instances and stub
         * out the persistance mechanism.
         */
        makeStubbedMany(count: number, callback?: (model: InstanceType<FactoryModel['model']>, ctx: FactoryContextContract) => void): Promise<InstanceType<FactoryModel['model']>[]>;
        /**
         * Create and persist more than one model instance
         */
        createMany(count: number, callback?: (model: InstanceType<FactoryModel['model']>, ctx: FactoryContextContract) => void): Promise<InstanceType<FactoryModel['model']>[]>;
    }
    /**
    ...
    export interface FactoryModelContract<Model extends LucidModel> {
         ...
         */
        state<K extends string>(state: K, callback: StateCallback<InstanceType<Model>>): this & {
            states: {
                [P in K]: StateCallback<InstanceType<Model>>;
            };
        };
        /**
